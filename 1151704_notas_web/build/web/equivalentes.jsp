    ...
    <body>
        ...
        <section class="main-page">
            <div class="ed-container">
                <div class="ed-item">
                    <h3 class="main-titulo">Administración de equivalentes</h3>
                </div>
                <div class="ed-item s-mb-1">
                    <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modal-equivalenteRegistrar">Registrar</button>
                </div>
                <div class="ed-item s-mb-1">
                    <div class="form-group">
                        <label>Alumno</label>
                        <select class="form-control" id="selectListadoFiltro" 
                                data-url="listados/equivalentesListado.jsp">
        ...
        <div class="modal fade" id="modal-equivalenteRegistrar" role="dialog">
            <form action="registrarEquivalente" method="post">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <% if (carrerasListado != null && !carrerasListado.isEmpty()) { %>
                            <div class="form-group">
                                <label>Carrera Matriculada</label>
                                <select class="form-control" name="carreraM">
                                    <% for (Carrera car : carrerasListado) {%>
                                    <option value="<%=car.getCodigo()%>"><%=car.getNombre()%></option>
                                    <% } %>
                                </select>
                            ...
                            <% if (asignaturasListado != null && !asignaturasListado.isEmpty()) { %>
                            <div class="form-group">
                                <label>Asignatura Matriculada</label>
                                <select class="form-control" name="asignaturaM">
                                    <% for (Asignatura asig : asignaturasListado) {%>
                                    <option value="<%=asig.getCodAsignatura()%>"><%=asig.getNombre()%></option>
                                    <% } %>
                                </select>
        ...
        <div class="modal fade" id="modal-equivalenteEliminar" role="dialog">
            <form action="eliminarEquivalente" method="post">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Eliminar Equivalente</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
